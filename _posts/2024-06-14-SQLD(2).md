...
# 그룹 함수 : COUNT, SUM, MIN, MAX, AVG, VARIANCE, STDDEV
...
# 윈도우 함수 : 서로 다른 행의 비교나 연산을 위해 만든 함수, 그룹 연산O
...
# DML(DATA Manipulation Language) : 삽입, 수정, 삭제, 병합(merge)
...
# TCL(Transcation Control Language) : COMMIT, ROLLBACK,
...
# DDL(Data Definition Language) :객체 생성, 삭제, 변경
